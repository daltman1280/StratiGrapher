...
- (void)initializeTable
{
	...
	NSAssert1(self.stratum.grainSizeIndex >= grainSizeFineSiltAndClay && (int) self.stratum.grainSizeIndex <= grainSizeBoulders+1, @"Illegal grain size index = %d", self.stratum.grainSizeIndex);
