...
- (void)pencilTouchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:(NSString *)SREditingOperationStarted object:self];	// disable scrolling
...
- (void)pencilTouchesEnded:(NSSet *)touches withEvent:(UIEvent *)event;
{
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:(NSString *)SREditingOperationEnded object:self];	// re-enable scrolling
	[self.overlayContainer.overlay setNeedsDisplay];
}
